...
export default function ProfesionalnaWebStranica() {
  ...
  const post = {
    id: 1,
    title: "Zašto je profesionalna web stranica ključna za uspjeh vašeg biznisa",
    excerpt: "U digitalnom dobu, web stranica nije samo opcija - ona je neophodna. Saznajte kako kvalitetna web prezentacija može transformirati vaš biznis i privući nove klijente.",
    content: [
      {
        type: "paragraph",
        text: "U današnjem digitalnom svijetu, prvi utisak koji potencijalni klijenti stvore o vašem biznisu često dolazi kroz vašu web stranicu. Bez obzira na to koliko su vaš proizvod ili usluga kvalitetni, ako vaša online prezentacija nije na nivou, možete izgubiti brojne prilike za rast i razvoj."
      },
      {
        type: "image",
        src: "/images/profesionalna-web-stranica.jpg",
        alt: "Modern web design team",
        caption: "Profesionalan dizajn ostavlja snažan prvi utisak."
      },
      {
        type: "heading",
        text: "Prvi utisak je ključan",
        icon: <StarIcon className="inline w-6 h-6 text-yellow-500 mr-2 align-middle" />
      },
      {
        type: "paragraph",
        text: "Istraživanja pokazuju da korisnici formiraju prvi utisak o web stranici u samo 50 milisekundi. To znači da imate manje od sekunde da impresionirate posjetioce i uvjerite ih da ostanu na vašoj stranici. Profesionalna web stranica s modernim dizajnom, brzim učitavanjem i intuitivnom navigacijom može značajno poboljšati taj prvi utisak."
      },
      {
        type: "highlight",
        color: "emerald",
        title: "Ključne prednosti profesionalne web stranice:",
        items: [
          "Povećava kredibilitet i povjerenje",
      ...
      {
        type: "heading",
        text: "Kredibilitet i pouzdanost",
        icon: <BarChartIcon className="inline w-6 h-6 text-blue-500 mr-2 align-middle" />
      },
      {
        type: "paragraph",
        text: "Kvalitetna web stranica gradi povjerenje i kredibilitet. Potencijalni klijenti često procjenjuju profesionalnost kompanije na osnovu kvaliteta njihove online prezentacije. Stranica koja izgleda zastarjelo ili nefunkcionalno može dovesti do gubitka povjerenja – čak i ako je vaš proizvod odličan."
      },
      {
        type: "image",
        src: "/images/web.jpeg",
        alt: "Dizajner radi na web stranici koristeći laptop",
        caption: "Povjerenje se gradi kroz moderan i pouzdan web nastup."
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Za razliku od fizičke lokacije, vaša web stranica dostupna je 24 sata dnevno, 7 dana u sedmici. To znači da potencijalni klijenti mogu saznati o vašim uslugama, pregledati vaše proizvode ili vas kontaktirati u bilo koje vrijeme, bez obzira na radno vrijeme."
      },
    ],
    image: "/images/profesionalna-web-stranica.jpg",
